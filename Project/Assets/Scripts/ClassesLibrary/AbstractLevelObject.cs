...
namespace ClassesLibrary {
	...
	public abstract class AbstractLevelObject : SelfRegistrable
	{
            ...
            : this()
		{
			...
			m_sObjectDescriptor = ParseObjectDescriptor(
				sObjectDescription,
				out orientation,
				out objectName );
		...
		static public void SetStatics(
			ref GameLogic gameLogic,
			...
			out String sObjectName)
		{
			...
			if( 0 <= dollarPos ) {
				...
				String sAzimuth = sObjectDescription.Substring( orientationStart,
				                                                orientationEnd - orientationStart + 1 );
			...
			if( 0 <= backslashPos ) {
				...
				sObjectNumber = sObjectDescription.Substring( numberStart,
				                                              numberEnd - numberStart + 1 );
			}

			int descriptorLen = Math.Min( descriptorLen1, descriptorLen2 );
			String sObjectDescriptor = sObjectDescription.Substring( 0,
			                                                         descriptorLen );
