    ...
    public class GameLevelParser
    {
        ...
        public bool LoadFromFile(String fileName, Encoding encoding)
        {
            ...
            do {
                ...
                if( nLineCount <= nCurrLine || sHeaderLine != allLines[ nCurrLine++ ] ) {
                    break;
                }
                ...
                if( !sStaticLine.StartsWith( sStaticLineStart ) || !sStaticLine.EndsWith( sStaticLineEnd ) ) {
                    break;
                }
